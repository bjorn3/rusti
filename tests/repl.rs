...
fn test_eval() {
    assert_eq!(
        repl_eval(r#"println!("Hello, world!");"#),
        "Hello, world!\n"
    );
...
fn test_load() {
    assert_eq!(
        repl_input(".l data/test_load.rs\nhello(\"world\");"),
        "Hello, world!\n"
    );
}
